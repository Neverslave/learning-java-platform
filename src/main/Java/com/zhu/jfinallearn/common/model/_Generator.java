...
import com.zhu.jfinallearn.common.JfinalConfig;
...
public class _Generator {
    ...
    public static void main(String[] args) {
        // base model 所使用的包名
        String baseModelPackageName = "com.zhu.jfinallearn.common.model.base";
        // base model 文件保存路径
        String baseModelOutputDir = PathKit.getWebRootPath()
                + "/src/main/java/com/zhu/jfinallearn/common/model/base";

        System.out.println("输出路径："+ baseModelOutputDir);

        // model 所使用的包名 (MappingKit 默认使用的包名)
        String modelPackageName = "com.zhu.jfinallearn.common.model";
